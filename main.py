        ...
        if response.status_code == 200:
            ...
            if player_data:
                ...
                if discord_id:
                    ...
                    gif_url = "https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExYTVibDN4bW44bDNndHF2emhqOGU2OHBoOHU3bTFobjQ0bzAwcTU0NyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/ANYARlYLs8s5MI7VD2/giphy.gif"
                    embed.set_image(url=gif_url)

                    embed.set_footer(text=f"ค้นหาข้อมูลโดย {channel.guild.name}", icon_url=channel.guild.icon.url)
                    embed.set_author(name="ดุ๋ยเช็คให้", icon_url="https://img5.pic.in.th/file/secure-sv1/151050578_1128789120913305_2479199762242523600_n.jpg")
...
async def check(ctx, player_id: str):
    ...
    embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/923422461725409330/1308585609501347941/33366973bc8e72469129aaa240c6baa7.gif?ex=673e7ad1&is=673d2951&hm=4ce27cd3a62cf9b26b282caa6fc3fddd003e9e248aa0c15706659eb30342738e&")
